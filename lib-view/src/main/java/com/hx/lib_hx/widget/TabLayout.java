...
//                Path path = new Path();
//                float angleWid = mIndicatorRight / 10;
//                float angleHei = angleWid / 3;
//                path.moveTo(mIndicatorRight / 2 - angleWid / 2, getHeight());
//                path.lineTo(mIndicatorRight / 2 + angleWid / 2, getHeight());
//                path.lineTo(mIndicatorRight / 2, getHeight() - angleHei);
//                path.close();
...
//                    canvas.drawRoundRect(oval3,30,30,mSelectedIndicatorPaint);
                    ...
                    Path path = new Path();
                    float angleWid = mTabLineOffset;
                    float angleHei = (float) (angleWid *0.86);
                    path.moveTo(tabCenter-angleWid/2, getHeight());
                    path.lineTo(mIndicatorRight-width/2+angleWid/2, getHeight());
                    path.lineTo(mIndicatorRight-width/2, getHeight() - angleHei);
                    path.close();
                    canvas.drawPath(path, mSelectedIndicatorPaint);
                }
            }
